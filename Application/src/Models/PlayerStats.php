...
class PlayerStats {
    ...
    public static function create(array $data): bool {
        $pdo = Database::connection();
        $stmt = $pdo->prepare("
            INSERT INTO PlayerStats (idPlayer, idMatch, points, minutes)
            VALUES (:idPlayer, :idMatch, :points, :minutes)
        ");
    ...
    public static function deleteByMatch(int $matchId): bool {
        $pdo = Database::connection();
        $stmt = $pdo->prepare("DELETE FROM PlayerStats WHERE idMatch = :matchId");
